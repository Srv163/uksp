(() => {
  ...
  const info={
    methodology:{title:'О показателях проектов',content:'<p>Показаны все пять реализованных проектов портфолио 2023–2026, по убыванию цены продажи.</p><dl><div><dt>Стоимость приобретения</dt><dd>Стоимость входа в проект по портфолио. Состав входящих в неё расходов здесь не раскрывается.</dd></div><div><dt>Цена продажи</dt><dd>Сумма продажи без НДС. Не является чистой прибылью или доходом инвестора.</dd></div><div><dt>Срок владения</dt><dd>Число календарных дней от полной оплаты до продажи.</dd></div></dl><p>Суммы в заголовках карточек округлены до сотых миллиона рублей. Точные суммы доступны в раскрывающихся карточках. Оценочные цены непроданных активов в этот раздел не включены.</p>'},
